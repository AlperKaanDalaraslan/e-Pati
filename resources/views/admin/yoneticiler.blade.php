...
@endsection
@section('content')
    <br><h2 style="text-align: center">Yöneticiler</h2><br>
    @if(session('basarili'))
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('delete_yonetici', $dat->id) }}" method="post">
                            @csrf
                            <button type="submit" onclick="return confirm('BU YÖNETİCİYİ VE YÖNETİCİ İLE İLGİLİ KAYITLARI SİLMEK İSTEDİĞİNİZDEN EMİN MİSİNİZ?')" class="btn btn-danger">
