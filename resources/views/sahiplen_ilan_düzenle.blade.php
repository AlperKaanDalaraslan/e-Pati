...
@section('content')
    <div class="giris_navbar">
        <b class="baslik">Sahiplendirme İlanını Düzenle</b>
    </div>
    <div class="düzenle">
        ...
        <br>
        <br>
        <span class="baslik_düzenle" ><span class="icerik">Hayvanın kısırlık durumu: </span>{{$data->kisir == 1 ? 'Kısır' : 'Kısır Değil'}}</span>
        <br>
        <br>
    ...
    <form action="{{route('update_sahiplen',$data->id)}}" method="post" class="form-bolumu" enctype="multipart/form-data">
